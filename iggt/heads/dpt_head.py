...
from .adaptor import GeoProjector
...
class DPTHead(nn.Module):
    ...
    def _forward_impl(
        ...
        out, out_layer_feat = self.scratch_forward(out)
        ...
        if self.use_point_feat:
            return preds, conf, out_layer_feat
        else:
            return preds, conf
    ...
    def scratch_forward(self, features: List[torch.Tensor]) -> torch.Tensor:
        ...
        out_final = self.scratch.output_conv1(out1)
        return out_final, (out2, out3, out4)
